...
<body style="word-spacing: normal; background-color: #ffffff">
  <div style="
        ...
        overflow: hidden;
      ">
    Monthly releases, collabs and more. ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏  ͏
                              ...
                              <tr>
                                <td style="
                                  ...
                                  <div class="content-padding first last">
                                    ...
                                    <div class="kl-row colstack" style="
                                          display: table;
                                          table-layout: fixed;
                                          width: 100%;
                                        ">
                                      <!--[if true]><td style="vertical-align:top;width:600px;"><![endif]-->
                                      <div class="kl-column" style="
                                            display: table-cell;
                                            vertical-align: top;
                                            width: 100%;
                                          ">
                                        <div class="mj-column-per-100 mj-outlook-group-fix component-wrapper" style="
                                              font-size: 0px;
                                              text-align: left;
                                              direction: ltr;
                                              vertical-align: top;
                                              ...
                                              <tr>
                                                <td class="" style="
                                                  ...
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td align="center" class="kl-image" style="
                                                              font-size: 0px;
                                                                      ...
                                                                      <tr>
                                                                        <td align="center" style="text-align: center;">
                                                                          <a style="display: inline-block;">
                                                                            <img
                                                                              src="https://cdn-icons-png.freepik.com/256/8523/8523899.png"
                                                                              style="display: block; height: 200px; width: 200px; margin: 0 auto;"
                                                                              alt="Chứng chỉ" />
                                                                          </a>
                                                                        </td>
                                                                      </tr>
                                    ...
                                    <div class="kl-row colstack" style="
                                      ...
                                      <div class="kl-column" style="
                                              ...
                                              <tr>
                                                <td class="" style="
                                                  ...
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td align="left" class="kl-text" style="
                                                              font-size: 0px;
                                                              padding: 0px;
                                                              padding-top: 9px;
                                                              padding-right: 100px;
                                              ...
                                              <tr>
                                                <td class="" style="
                                                  ...
                                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td align="center" class="kl-button" style="
                                                              font-size: 0px;
                                                              padding: 0px;
                                                              word-break: break-word;
                                                              ...
                                                              <tr>
                                                                <td align="center" bgcolor="#000000" role="presentation"
                                                                  ...
                                                                  <a style="
                                                                        ...
                                                                        border-radius: 3px;
                                                                      " target="_blank"
                                                                    href="http://localhost:5173/hoc-vien/lay-lai-mat-khau/{{
                                                                                                                                    $hash_reset
                                                                                                                                    }}">
                                                                    Bấm vào
                                                                    đây
                                        ...
                                        <p style="
                                              ...
                                              text-align: center;
                                            ">
                                          <span style="font-size: 14px">Nếu bạn có vấn đề gì cần hỗ trợ
